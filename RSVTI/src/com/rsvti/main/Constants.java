...
public class Constants {
	...
	public static final String XML_DB_FILE_NAME = "RSVTI_database.xml";
	public static final String XML_RIG_PARAMETERS = "RigParameters.xml";
	...
	public static int ERR_LOG_REPLACE_TIME_UNIT = Calendar.SECOND;
	public static int ERR_LOG_REPLACE_INTERVAL = 10;
